...
for (let i = 0; i < featuredSpeakers1.length; i += 1) {
  ...
  speakers1.innerHTML += `
       ...
       <div  id='${featuredSpeaker1.id}' class='card-wraper col-xl-4 align-items-center py-3 mb-5'>
       <div class="row ">
        ...
        <div class="description col-8 no-gutters">
...
for (let i = 0; i < featuredSpeakers1.length; i += 1) {
   ...
   speakers2.innerHTML += `
      ...
      <div  id='${featuredSpeaker2.id}' class='card-wraper col-xl-4 align-items-center py-3 mb-5'>
       <div class="row ">
         <div class="images col-4">             <img class="image1 img-fluid" src="${featuredSpeaker2.img1}" alt="" width=70% height=80%>
 ...
 for (let i = 0; i < featuredSpeakers1.length; i += 1) {
   ...
   speakers3.innerHTML += `
        ...
        <div  id='${featuredSpeaker3.id}' class='card-wraper col-xl-4 align-items-center py-3 mb-5'>
        <div class="row ">
         <div class="images col-4">
